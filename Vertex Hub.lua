...
local function showAccessDenied()
	pcall(function()
		...
		shade.BackgroundColor3 = Color3.fromRGB(5, 10, 18)
		...
		card.BackgroundColor3 = Color3.fromRGB(16, 28, 42)
		...
		message.Size = UDim2.new(1, -40, 0, 52)
		message.Position = UDim2.new(0, 20, 0, 62)
		message.BackgroundTransparency = 1
		message.Text = "You are not authorized to use this script.\nContact itzonlyfisher on Discord for help."
		message.TextColor3 = Color3.fromRGB(170, 190, 205)
		message.TextSize = 14
		...
		close.Position = UDim2.new(0, 20, 1, -56)
		close.BackgroundColor3 = Color3.fromRGB(55, 180, 230)
		close.BorderSizePixel = 0
		close.Text = "Close"
		close.TextColor3 = Color3.fromRGB(8, 15, 24)
		close.TextSize = 14
